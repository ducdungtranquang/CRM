...
export default function ChatBusiness() {
  ...
  const { isOpen, toggleModal } = useModal(styles.business_assistant, [styles.business_assistant]);
  ...
  return (
    <div ref={chatRef} className={styles.business_assistant}>
      <div className={styles.business_assistant_header} onClick={handleOpenChatBody}>
